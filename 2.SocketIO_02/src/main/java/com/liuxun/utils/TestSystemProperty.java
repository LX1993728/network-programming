...
public class TestSystemProperty {
	...
	public static void main(String[] args) {
		...
		System.out.println("当前程序所在目录：" + System.getProperty("user.dir")); // 当前程序所在目录(工程根目录)
		System.out.println("当前类所在路径: "+TestSystemProperty.class.getClassLoader().getResource("").getPath());
	}
}
